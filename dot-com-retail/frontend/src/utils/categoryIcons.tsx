 ...
 * @param iconName - The icon identifier from the backend
 * @returns React.ReactElement - The SVG path element
 */
export const getCategoryIcon = (iconName: string | null | undefined): React.ReactElement => {
